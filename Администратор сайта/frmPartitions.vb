...
Public Class frmPartitions
    Private Sub frmPartitions_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Console.WriteLine("frmPartitions open" & vbCrLf)
        MdiParent = frmMain
        TreeView1.Nodes.Clear()
        FillDataFromDataBase("Sites")
        FillDataFromDataBase("Partitions")
        Console.WriteLine("frmPartitions load entities" & vbCrLf)
    End Sub
    Sub FillDataFromDataBase(ByVal SelectTable As String)
        PartitionsCount = 0
        Dim i As Integer = 0
        Try
            Dim DataReader1 As OleDbDataReader
            Dim Command1 As New OleDbCommand("SELECT * FROM " & SelectTable, ConnectToDataBase)
            ConnectToDataBase.Open()
            DataReader1 = Command1.ExecuteReader
            While DataReader1.Read()
                If SelectTable = "Sites" Then
                ...
                Else
                    ...
                    For i = 0 To TreeView1.Nodes.Count - 1
                        If DataReader1.GetValue(2) = TreeView1.Nodes(i).Tag Then
                            TreeView1.Nodes(i).Nodes.Add(DataReader1.GetValue(1))
    ...
    Private Sub ToolStripButton4_Click(sender As Object, e As EventArgs) Handles ToolStripButton4.Click
        Console.WriteLine("frmPartitions close" & vbCrLf)
        Me.Close()
    End Sub
End Class